...
def main() -> None:
    container_name = "ultralytics/ultralytics:latest"
    # 启动容器
    ok, msg = start_docker(
        host_port=8000,
    ...
    try:
        resp = request_batch_split(
            ...
            images_dir="/workspace/TDL/dataset/images",
            weights="/workspace/TDL/yolo11x.pt",
            labels_dir="/workspace/TDL/dataset/labels",
            device="cuda",
            no_visualize=True,
        )
        print("API 返回：")
